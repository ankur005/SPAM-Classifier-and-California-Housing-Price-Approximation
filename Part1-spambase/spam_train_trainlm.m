...
for i = 1:2
    ...
    savePerformancePlot(['Performance_lm_',num2str(hiddenLayerSize(i))],tr);
    saveErrorHistogram(['ErrorHist_lm_',num2str(hiddenLayerSize(i))],gsubtract(T_train,net(P_train)));
    saveTrainStatePlot(['TrainState_lm_',num2str(hiddenLayerSize(i))],tr);
    saveRegressionPlot(['Reg_lm_',num2str(hiddenLayerSize(i))],T_train,net(P_train));
end
