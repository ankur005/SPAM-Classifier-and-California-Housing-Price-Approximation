...
for i = 1:size(hiddenLayerSize)
    ...
    savePerformancePlot(['Performance_6040_hidlayer_size_',strrep(num2str(hiddenLayerSize(i)),'.','_')],tr);
    saveErrorHistogram(['ErrorHist_6040_hidlayer_size_',strrep(num2str(hiddenLayerSize(i)),'.','_')],gsubtract(T_train,net(P_train)));
    saveTrainStatePlot(['TrainState_6040_hidlayer_size_',strrep(num2str(hiddenLayerSize(i)),'.','_')],tr);
    saveRegressionPlot(['Reg_6040_hidlayer_size_',strrep(num2str(hiddenLayerSize(i)),'.','_')],T_train,net(P_train));
end
